...
const GRAPH_MODE_ENABLED = (process.env.NEXT_PUBLIC_GRAPH_RAG_ENABLED ?? "true").toLowerCase() === "true";
          ...
          <section className="col-span-12 card card-soft-primary shadow-xl interactive-card">
            <div className="card-body space-y-6">
              <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
                <div>
                  <p className="text-xs font-semibold uppercase tracking-wide text-primary">Laboratory</p>
                  <h1 className="card-title text-3xl text-base-content">Scientia Laboratory</h1>
